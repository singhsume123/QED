...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { capacity: @table.capacity, restaurant_id: @table.restaurant_id, status: @table.status }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { capacity: @table.capacity, restaurant_id: @table.restaurant_id, status: @table.status }
    assert_redirected_to table_path(assigns(:table))
  end
